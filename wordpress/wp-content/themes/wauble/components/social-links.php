...
<ul class="<?php echo implode(' ', $list_classes); ?>">
  ...
  <li class="social-icons-item">
    <a
      href="<?php echo get_field('facebook_link', 'option'); ?>"
      target="_blank"
      rel=”noopener”
  ...
  <?php endif; ?>
  <?php if (!empty(get_field('twitter_link', 'option'))) : ?>
  <li class="social-icons-item">
    <a
  ...
  <li class="social-icons-item">
    <a
      href="<?php echo get_field('instagram_link', 'option'); ?>"
      target="_blank"
      rel=”noopener”
  ...
  <?php endif; ?>
  <?php if (!empty(get_field('pinterest_link', 'option'))) : ?>
  <li class="social-icons-item">
    <a
      href="<?php echo get_field('pinterest_link', 'option'); ?>"
      target="_blank"
      rel=”noopener”
  ...
  <?php endif; ?>
  <?php if (!empty(get_field('youtube_link', 'option'))) : ?>
  <li class="social-icons-item">
    <a
      href="<?php echo get_field('youtube_link', 'option'); ?>"
      target="_blank"
      rel=”noopener”
