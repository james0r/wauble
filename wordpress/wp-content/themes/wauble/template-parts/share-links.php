...
?>
<div
  class="fixed top-1/2 -translate-y-1/2 right-0 self-start hidden lg:block"
>
  <!-- Facebook -->
  <a
    class=""
  ...
  >
    <div
      aria-hidden="true"
      class="h-[54px] w-[54px] transition bg-[#55acee] hover:bg-[#2795e9] flex items-center justify-center"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
